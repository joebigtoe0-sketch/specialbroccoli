...
const HOLDERS = JSON.parse(document.getElementById('mock-holders-json').textContent);
const TOTAL_DISTRIBUTED_SOL = 342.81;
const ACTIVE_HOLDERS = 2147;
...
function StatsBar() {
  ...
  const tiles = [
    ...
    { label:'ACTIVE HOLDERS',    value: ACTIVE_HOLDERS.toLocaleString(),            accent:'var(--ice-100)' },
      ...
      <div className="container">
        ...
        <div style={{ display:'flex', alignItems:'flex-end', justifyContent:'space-between', flexWrap:'wrap', gap:16 }}>
          ...
          <div style={{ display:'flex', gap:8, flexWrap:'wrap' }}>
            <span className="pill">{ACTIVE_HOLDERS.toLocaleString()} HOLDERS</span>
